...
const templates: Record<string, PlanTemplate> = {
  pullups: {
    ...
    description: ` *Программа: Подтягивания с доп. весом(пул)*\n` +
      ...
      ` Тренировки: Пн, Ср, Пт\n\n` +
      `*Будет составлен план на 9 недель с планомерным увеличением веса.*`,
    weightPrompt: " *Укажи свой рабочий вес на 8ПМ* (вес,навесив на себя которую,ты можешь выполнить 8 повторении):\n\n Пример: 15",
    weightType: '8pm',
  ...
  bench_dips: {
    ...
    description: ` *Программа для Жима или для Брусья с доп. весом*\n` +
      ...
      ` Тренировки: Пн, Ср, Пт\n\n` +
      `*Будет составлена подробная программа на 6 недель для жима штанги или отжиманий на брусьях.*`,
  ...
  wrists: {
    ...
    description: `*Программа: Скручивание на кисть на одну руку/любые арм движения*\n` +
      ...
      `*Будет составлена программа на 6 недель для укрепления связок, кисти и предплечий.*`,
