...
exports.textLooksLikeProgram = exports.parseTrainingText = void 0;
function parseTrainingText(raw) {
    ...
    for (const k of Object.keys(schedule)) {
        if (!schedule[k] || !schedule[k].length)
            delete schedule[k];
    }
    return Object.keys(schedule).length ? schedule : null;
}
exports.parseTrainingText = parseTrainingText;
// Грубая проверкa
function textLooksLikeProgram(text) {
...
exports.textLooksLikeProgram = textLooksLikeProgram;
