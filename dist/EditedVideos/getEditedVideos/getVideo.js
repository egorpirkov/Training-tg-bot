...
exports.getVideoHandler = void 0;
const adminChatId = 8088541468; //мой айди
const waitingForVideo = new Set(); //хранитель айдишников юзеров
function getVideoHandler(bot) {
    ...
    bot.on("message", async (msg) => {
        ...
        if (waitingForVideo.has(chatId)) {
            if (msg.video || msg.document) {
                await bot.sendMessage(adminChatId, `📥 Пользователь @${msg.from?.username || msg.from?.id} прислал видео`);
