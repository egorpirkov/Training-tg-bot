#  [@MentzerMike_bot](https://t.me/MentzerMike_bot) — Умный силовой-помощник в Telegram ФОРК ПИРКОВА
...
**MentzerBot** — телеграм-бот для спортсменов: считает 1ПМ, оценивает рекорды по возрасту и весу, составляет тренировочные планы, распознает программы с фото и быстро скачивает видео/звук по ссылкам из TikTok.
...
* ** Интерактивный конструктор программ (`/createprogram`)**
